...
export default function ActivityTab() {
  ...
  const activities = useMemo(() => {
    ...
    return {
      ...
      usage: calcActivity('explorer_usage'),
    };
  }, [ activityQuery.data ]);
  ...
  const tasks = useMemo(() => (
    [
      ...
      },
      {
        ...
        maxAmount: getMaxAmount(rewardsConfigQuery.data?.rewards?.explorer_usage_activity_rewards),
      },
    ]
        ...
        <div className="contents md:flex md:flex-col md:w-[340px] md:p-3 md:pr-0">
          <div className="flex flex-col p-1.5 md:p-0 pb-0">
            ...
            <div className="flex items-center gap-3 mb-0 md:mb-4">
              ...
              <Link
                external
                href="https://docs.lux.network/using-explorer/merits/activity-pass"
