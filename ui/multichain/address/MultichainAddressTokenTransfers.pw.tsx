...
import MultichainAddressTokenTransfers from './MultichainAddressTokenTransfers';
  ...
  test.beforeEach(async({ render, mockMultichainConfig, mockEnvs, mockApiResponse, mockAssetResponse, createSocket }) => {
    ...
    component = await render(
      <Box pt={{ base: '134px', lg: 6 }}>
        <MultichainAddressTokenTransfers addressData={ addressMock.addressA } isLoading={ false }/>
      </Box>,
      { hooksConfig },
      { withSocket: true },
    );
