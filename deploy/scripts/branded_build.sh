...
NETWORK_RPC_URL=https://api.lux.network/v1/chain/C/rpc
...
NETWORK_CURRENCY_NAME=LUX
NETWORK_CURRENCY_SYMBOL=LUX
NETWORK_RPC_URL=https://api.lux-test.network/v1/chain/C/rpc
...
NETWORK_RPC_URL=https://api.zoo.network/v1/chain/C/rpc
...
NETWORK_CURRENCY_NAME=Zoo
NETWORK_CURRENCY_SYMBOL=ZOO
NETWORK_RPC_URL=https://api.zoo-test.network/v1/chain/C/rpc
...
NETWORK_RPC_URL=https://api.hanzo.network/v1/chain/C/rpc
...
NETWORK_CURRENCY_NAME=AI
NETWORK_CURRENCY_SYMBOL=AI
NETWORK_RPC_URL=https://api.hanzo-test.network/v1/chain/C/rpc
...
NETWORK_RPC_URL=https://api.pars.network/v1/chain/C/rpc
...
NETWORK_CURRENCY_NAME=Pars
NETWORK_CURRENCY_SYMBOL=PARS
NETWORK_RPC_URL=https://api.pars-test.network/v1/chain/C/rpc
